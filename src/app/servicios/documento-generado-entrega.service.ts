...
export class DocumentoGeneradoEntregaService {
  ...
  //private URL = "http://159.223.107.115:3000/documentoGenerado";
  private URL = `${environment.services.urlServices}/documentoGenerado`;
  ...
  updateEstado(documento, estado: string) {
    return this.http.put(
      this.URL + `/updateEstado/${documento._id}/${estado}`,
      documento
    );
  }
