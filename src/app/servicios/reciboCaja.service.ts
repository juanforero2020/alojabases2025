...
export class ReciboCajaService {
  ...
  private URL = `${environment.services.urlServices}/reciboCaja`;
  ...
  getReciboCajaPorNumeroDocumento(idRecibo) {
    return this.http.post(this.URL + "/getReciboCajaPorNumeroDocumento", idRecibo);
  }
